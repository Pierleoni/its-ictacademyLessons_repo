...
Come abbiamo già visto, il registry ufficiale di Docker è **[Docker Hub](https://hub.docker.com/repositories)**, ma ne esistono molti altri (es. GitHub Container Registry `ghcr.io`, Google Container Registry, ecc.).
