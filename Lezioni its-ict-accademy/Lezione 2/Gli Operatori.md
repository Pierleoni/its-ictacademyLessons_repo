...
1. `x / y`
- **Cosa succede?** 
  Se proviamo a fare la divisione di `x` per `y` dove `y = 0`, otteniamo un errore perché **non è possibile dividere per zero**. Questo è un errore di **ZeroDivisionError**.
```python
x = 5
y = 0
print(x / y)
